...
const runner = async search => {
  var stream;
  // console.log("Creamos el browser instancia");
  // const browserFetcher = puppeteer.createBrowserFetcher({
  //   product: "firefox",
  //   path: './browser'
  // })
  // console.log("Descargamos el navegador")
  // const revisionInfo = await browserFetcher.download('968.0a1');
  ...
  // const browser = await launch(browserFire,
  //   {
  ...
  await page.goto("https://hub.docker.com/_/node/tags", {
